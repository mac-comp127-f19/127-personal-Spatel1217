...
public class InkBlot {
    ...
    public void generateInkBlot() {
        ...
        RandomWalk walkX = new RandomWalk(150);
        RandomWalk walkY = new RandomWalk(150);
        RandomWalk walkRed = new RandomWalk(150);
        RandomWalk walkBlue = new RandomWalk(150);
        RandomWalk walkGreen= new RandomWalk(150);

        for (int i = 0; i < 15000; i++) {
            getColor(walkRed, walkGreen, walkBlue);
            canvas.add(mirror(advance(walkX, walkY)));
        }
