...
public class TrainCar extends GraphicsGroup {
    ...
    /* Dimensions of the frame of a activityStarterCode.train car */
    public static final double CAR_WIDTH = 75*SCALE;
    public static final double CAR_HEIGHT = 36*SCALE;

    /* Distance from the bottom of a activityStarterCode.train car to the track below it */
    ...
    /* Draws the common part of a activityStarterCode.train car */
    ...
    public static double getCarWidth() {
        return CAR_WIDTH;
    }
}
