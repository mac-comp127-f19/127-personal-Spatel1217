...
public class Emojis {
    ...
    public static GraphicsGroup createSmileyFace(double size) {
        ...
        // TODO: create eyes
        /*Ellipse leftEye = createEye(size/10);
        Ellipse rightEye = createEye(size/10);

        leftEye.setCenter(size * .3, size/2.5);
        rightEye.setCenter(size * .7, size/2.5);

        group.add((leftEye));
        group.add(rightEye);*/

        Ellipse leftEye = createEye(size * .1);
        Rectangle rightEye = createWinkingFace(size * .1);
    ...
    private static Rectangle createWinkingFace(double size) {
