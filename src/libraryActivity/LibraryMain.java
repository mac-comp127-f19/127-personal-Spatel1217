...
public class LibraryMain {
    ...
    public static void main(String[] args) {
        ...
        library.add(new Video("My Neighbor Totoro", "Hayao Miyazaki", 5));
        library.add(new Video("Cats: A String on A Stick", "Generic Dude", 2));
        library.add(new Video("Cosmos", "Literally God", 1));
